...
impl Variant {
    ...
    pub fn to_desc(&self) -> &str {
        match self {
            ...
            Variant::BaccaratAceOfSwords => "",
            Variant::BaccaratAceOfSorrows => "",
            Variant::Baccarat1929 => "",
            Variant::FirstResponseCricket => "",
            Variant::TheCricketRenegade => "",
            Variant::TheCricketWastelandRonin => "",
            Variant::FirstResponseCypher => "",
            Variant::CypherSwarmingProtocol => "",
            Variant::FirstResponseDocHavoc => "",
            Variant::DocHavoc2199 => "",
            Variant::DriftThroughTheBreach => "",
            Variant::Drift1929And2199 => "",
            Variant::Drift1609 => "",
            Variant::Drift1789 => "",
            Variant::TestSubjectDrift => "",
            Variant::FirstResponseEchelon => "",
            Variant::Echelon2199 => "",
            Variant::GargoyleWastelandRonin => "",
            Variant::Gargoyle2199 => "",
            Variant::GargoyleDragonRanger => "",
            Variant::GargoyleInfiltrator => "",
            Variant::GyrosaurSpeedDemon => "",
            Variant::GyrosaurRenegade => "",
            Variant::CaptainGyrosaur => "",
            Variant::ImpactRenegade => "",
            Variant::ImpactWastelandRonin => "",
            Variant::TheFairKnight => "",
            Variant::TheBerserkerKnight => "",
            Variant::TheKnight1929 => "",
            Variant::TheKnightsWastelandRonin => "",
            Variant::LadyOfTheWoodSeasonOfChange => "",
            Variant::MinistryOfStrategicScienceLadyOfTheWood => "",
            Variant::LadyOfTheWood2199 => "",
            Variant::MinistryOfStrategicScienceMagnificentMara => "",
            Variant::MagnificentMara1929 => "",
            Variant::ShardmasterMalichae => "",
            Variant::MinistryOfStrategicScienceMalichae => "",
            Variant::NecroWardenOfChaos => "",
            Variant::Necro1929 => "",
            Variant::NecroLastOfTheForgottenOrder => "",
            Variant::TheUnstablePyre => "",
            Variant::PyreWastelandRonin => "",
            Variant::PyreExpeditionOblask => "",
            Variant::TheUncannyQuicksilver => "",
            Variant::QuicksilverRenegade => "",
            Variant::HarbingerQuicksilver => "",
            Variant::StarlightGenesis => "",
            Variant::NightloreCouncilStarlight => "",
            Variant::StarlightArea51 => "",
            Variant::TheRunecarvedStranger => "",
            Variant::TheStranger1929 => "",
            Variant::TheStrangerWastelandRonin => "",
            Variant::TheStrangerInTheCorn => "",
            Variant::TangoOneGhostOps => "",
            Variant::TangoOne1929 => "",
            Variant::TangoOneCreedOfTheSniper => "",
            Variant::MinistryOfStrategicScienceTerminus => "",
            Variant::Terminus2199 => "",
            Variant::MinistryOfStrategicScienceTitan => "",
            Variant::Titan2199 => "",
            Variant::TitanOni => "",
            Variant::FirstResponseVanish => "",
            Variant::Vanish1929 => "",
            Variant::VanishTombOfThieves => "",
        }
    }
    ...
    pub fn from_hero(hero: Hero, i: u32) -> Option<Variant> {
        match (hero, i) {
            ...
            (Hero::Baccarat, 1) => Some(Variant::BaccaratAceOfSwords),
            (Hero::Baccarat, 2) => Some(Variant::BaccaratAceOfSorrows),
            (Hero::Baccarat, 3) => Some(Variant::Baccarat1929),
            (Hero::TheCricket, 1) => Some(Variant::FirstResponseCricket),
            (Hero::TheCricket, 2) => Some(Variant::TheCricketRenegade),
            (Hero::TheCricket, 3) => Some(Variant::TheCricketWastelandRonin),
            (Hero::Cypher, 1) => Some(Variant::FirstResponseCypher),
            (Hero::Cypher, 2) => Some(Variant::CypherSwarmingProtocol),
            (Hero::DocHavoc, 1) => Some(Variant::FirstResponseDocHavoc),
            (Hero::DocHavoc, 2) => Some(Variant::DocHavoc2199),
            (Hero::Drift, 1) => Some(Variant::DriftThroughTheBreach),
            (Hero::Drift, 2) => Some(Variant::Drift1929And2199),
            (Hero::Drift, 3) => Some(Variant::Drift1609),
            (Hero::Drift, 4) => Some(Variant::Drift1789),
            (Hero::Drift, 5) => Some(Variant::TestSubjectDrift),
            (Hero::Echelon, 1) => Some(Variant::FirstResponseEchelon),
            (Hero::Echelon, 2) => Some(Variant::Echelon2199),
            (Hero::Gargoyle, 1) => Some(Variant::GargoyleWastelandRonin),
            (Hero::Gargoyle, 2) => Some(Variant::Gargoyle2199),
            (Hero::Gargoyle, 3) => Some(Variant::GargoyleDragonRanger),
            (Hero::Gargoyle, 4) => Some(Variant::GargoyleInfiltrator),
            (Hero::Gyrosaur, 1) => Some(Variant::GyrosaurSpeedDemon),
            (Hero::Gyrosaur, 2) => Some(Variant::GyrosaurRenegade),
            (Hero::Gyrosaur, 3) => Some(Variant::CaptainGyrosaur),
            (Hero::Impact, 1) => Some(Variant::ImpactRenegade),
            (Hero::Impact, 2) => Some(Variant::ImpactWastelandRonin),
            (Hero::TheKnight, 1) => Some(Variant::TheFairKnight),
            (Hero::TheKnight, 2) => Some(Variant::TheBerserkerKnight),
            (Hero::TheKnight, 3) => Some(Variant::TheKnight1929),
            (Hero::TheKnight, 4) => Some(Variant::TheKnightsWastelandRonin),
            (Hero::LadyOfTheWood, 1) => Some(Variant::LadyOfTheWoodSeasonOfChange),
            (Hero::LadyOfTheWood, 2) => Some(Variant::MinistryOfStrategicScienceLadyOfTheWood),
            (Hero::LadyOfTheWood, 3) => Some(Variant::LadyOfTheWood2199),
            (Hero::MagnificentMara, 1) => Some(Variant::MinistryOfStrategicScienceMagnificentMara),
            (Hero::MagnificentMara, 2) => Some(Variant::MagnificentMara1929),
            (Hero::Malichae, 1) => Some(Variant::ShardmasterMalichae),
            (Hero::Malichae, 2) => Some(Variant::MinistryOfStrategicScienceMalichae),
            (Hero::Necro, 1) => Some(Variant::NecroWardenOfChaos),
            (Hero::Necro, 2) => Some(Variant::Necro1929),
            (Hero::Necro, 3) => Some(Variant::NecroLastOfTheForgottenOrder),
            (Hero::Pyre, 1) => Some(Variant::TheUnstablePyre),
            (Hero::Pyre, 2) => Some(Variant::PyreWastelandRonin),
            (Hero::Pyre, 3) => Some(Variant::PyreExpeditionOblask),
            (Hero::Quicksilver, 1) => Some(Variant::TheUncannyQuicksilver),
            (Hero::Quicksilver, 2) => Some(Variant::QuicksilverRenegade),
            (Hero::Quicksilver, 3) => Some(Variant::HarbingerQuicksilver),
            (Hero::Starlight, 1) => Some(Variant::StarlightGenesis),
            (Hero::Starlight, 2) => Some(Variant::NightloreCouncilStarlight),
            (Hero::Starlight, 3) => Some(Variant::StarlightArea51),
            (Hero::TheStranger, 1) => Some(Variant::TheRunecarvedStranger),
            (Hero::TheStranger, 2) => Some(Variant::TheStranger1929),
            (Hero::TheStranger, 3) => Some(Variant::TheStrangerWastelandRonin),
            (Hero::TheStranger, 4) => Some(Variant::TheStrangerInTheCorn),
            (Hero::TangoOne, 1) => Some(Variant::TangoOneGhostOps),
            (Hero::TangoOne, 2) => Some(Variant::TangoOne1929),
            (Hero::TangoOne, 3) => Some(Variant::TangoOneCreedOfTheSniper),
            (Hero::Terminus, 1) => Some(Variant::MinistryOfStrategicScienceTerminus),
            (Hero::Terminus, 2) => Some(Variant::Terminus2199),
            (Hero::Titan, 1) => Some(Variant::MinistryOfStrategicScienceTitan),
            (Hero::Titan, 2) => Some(Variant::Titan2199),
            (Hero::Titan, 3) => Some(Variant::TitanOni),
            (Hero::Vanish, 1) => Some(Variant::FirstResponseVanish),
            (Hero::Vanish, 2) => Some(Variant::Vanish1929),
            (Hero::Vanish, 3) => Some(Variant::VanishTombOfThieves),
            _ => None,
        }
    }
}
