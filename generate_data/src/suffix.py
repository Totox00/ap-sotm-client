...
def gladiator_count(state:CollectionState|SotmState,player:int)->bool:return [state.has(d.name,player) for d in data if d.category==SotmCategory.Gladiator].count(True)>=3
