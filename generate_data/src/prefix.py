...
class SotmState:
    ...
    def has_any(self,items:Iterable[str],_player:int)->bool:return any(item in self.items for item in items)
class SotmCategory(IntEnum):Scion=0;Hero=1;Villain=2;TeamVillain=3;Environment=4;Variant=5;VillainVariant=6;Filler=7;Trap=8;Event=9;Contender=10;Gladiator=11
